...
class DashboardController extends BaseController
{
    ...
    {
        $workspace = (new \App\Libraries\DashboardWorkspaceService())->build($this->currentUser() ?? [], (array) $this->request->getGet());
        return view('dashboard/index', ['pageTitle' => 'Mi inicio', 'user' => $this->currentUser(), 'workspace' => $workspace]);
    }
