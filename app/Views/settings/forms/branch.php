...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        <div class="mb-3">
            <h2 class="h5 mb-1">Sucursal nueva</h2>
            <p class="text-secondary mb-0">Registra una sucursal operativa para la empresa activa.</p>
        </div>
        <form method="post" action="<?= esc($formAction) . ($isPopup ? '?popup=1' : '') ?>" class="row g-3">
            ...
            <div class="col-md-7"><label class="form-label">Nombre</label><input class="form-control" name="name" required></div>
            <div class="col-md-5"><label class="form-label">Codigo</label><input class="form-control" name="code" required></div>
            <div class="col-12"><label class="form-label">Direccion</label><textarea class="form-control" name="address" rows="3"></textarea></div>
