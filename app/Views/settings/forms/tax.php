...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        <div class="mb-3">
            <h2 class="h5 mb-1">Impuesto nuevo</h2>
            <p class="text-secondary mb-0">Registra alicuotas y codigos impositivos para la empresa activa.</p>
        </div>
        <form method="post" action="<?= esc($formAction) . ($isPopup ? '?popup=1' : '') ?>" class="row g-3">
            ...
            <div class="col-md-3"><label class="form-label">Tasa %</label><input class="form-control" name="rate" required></div>
            <div class="col-md-6"><label class="form-label">Estado</label><select class="form-select" name="active"><option value="1">Activo</option><option value="0">Inactivo</option></select></div>
