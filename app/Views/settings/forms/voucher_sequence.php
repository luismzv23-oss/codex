...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        ...
        <form method="post" action="<?= esc($formAction) . ($isPopup ? '?popup=1' : '') ?>" class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">Prefijo</label><input class="form-control" name="prefix" maxlength="20" required><div class="form-text">Usa un prefijo distinto para cada numeracion de la empresa.</div></div>
            <div class="col-md-6"><label class="form-label">Correlativo inicial</label><input type="number" min="1" max="2147483646" step="1" class="form-control" name="current_number" value="1" required></div>
